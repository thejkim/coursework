...
a. CSC 331 - 0900
b. Jo Eun Kim
c. csc331-0900_kim_prog5.cpp
d. Program #5, due on 12/11/2019
e. To identify a minimum spanning tree in an undirected connected weighted graph
    utilizing the Prim MST algorithm.
**/
...
void printMST(int mst[], int graph[vertexCount][vertexCount]);

// Function to construct, represent graph using adjacency matrix representation  
void primMST(int graph[vertexCount][vertexCount]);
