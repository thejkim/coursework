...
CREATE TABLE `treated` (
  ...
  PRIMARY KEY (`caseID`,`sequence`,`procCode`),
  KEY `FK_TreatedProcedures` (`procCode`),
  CONSTRAINT `FK_TreatedHospitalCase` FOREIGN KEY (`caseID`) REFERENCES `hospitalcase` (`caseID`),
  CONSTRAINT `FK_TreatedProcedures` FOREIGN KEY (`procCode`) REFERENCES `procedure` (`procCode`)
